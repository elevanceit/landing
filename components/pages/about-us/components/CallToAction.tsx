...
import { IconForHire, IconForTalents, IconForSales, IconForContributors, IconForHireWhite, IconForTalentsWhite, IconForSalesWhite, IconForContributorsWhite } from '@/assets/icons';
